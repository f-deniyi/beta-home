...
const EditProduct = ({ productId }) => {
    const { product, isLoading: gettingProduct } = useGetSingleProductQuery({
        productId,
        ...
        >
            {
                delayed ? <Loader /> :
                    <>
                        {
                            isLoading || gettingProduct ? <Loader /> : <form>

                                <div className='flex items-center justify-between mb-6'>
                                    <p className='text-[18px] font-medium '>Edit Product details</p>
                                    <div onClick={() => document.getElementById('edit_product').close()} role='button'>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    <input type="checkbox" className="toggle"
                                        checked={product?.attributes?.length > 0}
                                        onChange={(e) => {
