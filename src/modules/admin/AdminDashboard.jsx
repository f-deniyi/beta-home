          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between md:space-x-[13px] space-y-[13px] md:space-y-0 py-1 mb-[20px] md:mb-[0px] ">
              <div className="hover:shadow-xl duration-150 h-[127px] rounded-[20px] bg-brandPrimary px-[14px] pt-[24px] pb-[22px] w-full  flex flex-col justify-center">
                <div className="flex gap-x-2 items-center mb-2">
                  <div className="bg-black rounded-[10px] w-[50px] h-[50px] flex items-center justify-center flex-shrink-0">
                    <img src={users_active} className="object-cover " alt='users' />
                  </div>
              ...
              <div className="hover:shadow-xl duration-150 h-[127px] rounded-[20px] bg-brandPrimary px-[14px] pt-[24px] pb-[22px] w-full  flex flex-col justify-center">
                <div className="flex gap-x-2 items-center mb-2">
                  <div className="bg-black rounded-[10px] w-[50px] h-[50px] flex items-center justify-center flex-shrink-0">
                    <img src={customers} className="object-cover " alt='users' />
                  </div>
              ...
              <div className="hover:shadow-xl duration-150 h-[127px] rounded-[20px] bg-brandPrimary px-[14px] pt-[24px] pb-[22px] w-full  flex flex-col justify-center">
                <div className="flex gap-x-2 items-center mb-2">
                  <div className="bg-black rounded-[10px] w-[50px] h-[50px] flex items-center justify-center flex-shrink-0">
                    <img src={vendor_active} className="object-cover w-[19px] h-[19px] " alt='users' />
                  </div>
      ...
      <div className="bg-white p-5 rounded-[16px] mb-3">
        <div className="flex items-center justify-between mb-5">
          <div className="flex gap-x-2 items-center">
            <div className="h-[8px] w-[8px] rounded-full bg-brandPrimary">

            </div>
            <p className="text-[#1C2A53] text-[20px] font-normal">Registered Users</p>
          </div>
          <div className="flex items-center gap-x-2">
            <p className="text-[14px] text=[#555F7E] font-semibold">View Details</p>
      ...
      <div className="bg-white p-5 rounded-[16px] mb-3">
        <div className="flex items-center justify-between mb-5">
          <div className="flex gap-x-2 items-center">
            ...
            <p className="text-[#1C2A53] text-[20px] font-normal">Package Management</p>
          </div>
          <div className="flex items-center gap-x-2">
            <p className="text-[14px] text=[#555F7E] font-semibold">View Details</p>
            <FiArrowRight size='16' color='#555F7E' />
