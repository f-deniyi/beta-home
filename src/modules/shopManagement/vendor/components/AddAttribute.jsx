...
const AddAttribute = ({ shopId }) => {
    ...
    const { addAttributeController, isLoading, isSuccess } = AddAttributeManager();
    const initialItem = {
        name: "",
        quantity: 1,
    };
                            ...
                            <div className='flex-grow'>
                                <div className="flex items-center bg-[#EDEDED] rounded-md w-full ml-3">
                                    ...
                                    <button className="px-5 py-2 bg-brandPrimary text-white rounded-r-md text-[#000] h-[60px]" onClick={(e) => {
                                        e.preventDefault()
                                        const inputElement = document.getElementById('value_field')
                                        inputElement.value = ''
                                ...
                                <div className='mt-[17px] ml-3 flex gap-2'>
                                    {
                                        sizeArray?.map(el =>
                                            <div className='flex items-center bg-black rounded-full  justify-between'>
                                                ...
                                                <div className='cursor-pointer ml-auto pr-2' onClick={() => {
                                                    deleteSize(el)
                                                }}>
