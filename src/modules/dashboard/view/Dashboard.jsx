...
const Dashboard = () => {
  ...
  } = useGetProviderServiceRequest({ enabled: true });
  const {
  ...
  return (
    <BaseDashboardNavigation title={"Dashboard"} hideSearch={false}>
      {isLoading || fetchingRequests || fetchingOrders ? (
        <Loader />
      ) : userShop?.shops.length > 0 ? (
        <>
          <div class="relative w-full">
            <div
              class="bg-cover bg-center h-[207px]  rounded-bl-[10px] rounded-br-[10px] w-full"
              style={{
            ...
            <div className="mt-3">
              <div className="flex items-center ">
                <h3 className="text-[21.457px] text-black font-medium mr-2">
                  {userShop?.shops[0]?.name}
                </h3>
                {userShop?.shops[0]?.is_verified && (
                  <img
                    src={verifiedIcon}
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mt-3 mb-2">
              ...
              <div className="flex items-center cursor-pointer">
                <p
                  className="pe-2 text-[#4F4F4F] text-[12px] "
                  onClick={() => {
        ...
        <div className="h-[80vh] w-full flex items-center justify-center flex-col">
          <EmptyContent
            ...
            content={"You don't have a shop yet"}
          />
      ...
      <ProductOrders shopId={userShop?.shops[0]?.id} />
