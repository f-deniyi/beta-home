...
import { close, user, productCategory, brand, beta } from '../../../assets/icons'
import { MdOutlineArrowForwardIos } from 'react-icons/md'
import CustomButton from '../../../generalComponents/Button'
import PackageTable from './PackageTable'

const PackageDetails = ({ type }) => {
        ...
        <>
            ...
            >
                <div className='flex items-center justify-between mb-6'>
                    ...
                    <div onClick={() => document.getElementById('package_details').close()} role='button'>
                ...
                <div className=' mb-[26px]'>
                    ...
                    <h3 className='text-[30px] font-semibold text-center'>3 Sitter Set of Chairs</h3>
                </div>


                <div className=' mt-[30px]'>
                    <div className='flex items-center justify-between mb-4'>
                        <p className='text-[12px] font-medium text-[#8E8E8E]'>Percentage penalty for 60days non payment</p>
                        <h3 className='text-[#212121] font-semibold text-[15px]'>20%</h3>
                    </div>
                    <div className='flex items-center justify-between mb-4'>
                        <p className='text-[12px] font-medium text-[#8E8E8E]'>Percentage penalty for 90days non payment</p>
                        <h3 className='text-[#212121] font-semibold text-[15px]'>30%</h3>
                    </div><div className='flex items-center justify-between mb-4'>
                        <p className='text-[12px] font-medium text-[#8E8E8E]'>Package amount</p>
                        <h3 className='text-[#212121] font-semibold text-[15px]'>N560,000</h3>
                    </div>
                </div>
