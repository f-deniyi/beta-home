    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex w-full">
                    <div className="grid  flex-grow text-center">
                        <p className='mb-0 text-[#696969] text-[15px] font-medium mb-2'>Customer Products Order</p>
                    ...
                    <div className="divider divider-horizontal w-[0.3px] bg-[#A5A5A5]" />
                    <div className="grid  flex-grow text-center">
                        <p className='mb-0 text-[#696969] text-[15px] font-medium mb-2'>Customer Service Order</p>
                        <h3 className='text-[30px] font-semibold '>2 Products</h3>
                        <div classNmw='w-1/3 mx-auto'>
                            <button
                                type="button"
                                onClick={() => {
